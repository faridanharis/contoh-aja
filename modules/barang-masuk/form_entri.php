          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <div id="data_stok" class="input-group-append"></div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-5 ml-auto">
              <div class="form-group">
                ...
                <input type="text" id="data_jumlah" name="jumlah" class="form-control" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required>
                <div class="invalid-feedback">Jumlah Barang masuk tidak boleh kosong</div>
              </div>

              <div class="form-group">
                <label>Total Stok <span class="text-danger">*</span></label>
                <input type="text" id="data_total" name="total" class="form-control" readonly>
              </div>
            </div>
          </div>
        </div>
