        ...
        <div class="table-responsive">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.stok, a.jenis, a.stok_minimum
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="200"><?php echo $data['stok_minimum']; ?></td>
                  <td width="200" ><?php echo $data['stok']; ?></td>
